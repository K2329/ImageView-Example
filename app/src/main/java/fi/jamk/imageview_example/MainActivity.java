package fi.jamk.imageview_example;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PATH = "http://student.labranet.jamk.fi/~K2329/ttms05/H3/kuvat/";
    // example image names (change to your own if needed...)
    private String[] images = {"talo1.jpg","talo2.jpg","talo3.jpg"};
